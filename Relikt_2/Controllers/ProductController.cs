...
namespace Relikt_2.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        {
            IEnumerable<Product> objList = _prodRepo.GetAll(includeProperties:"Category,ApplicationType,SizeType");
            ...
            //    obj.SizeType = _db.SizeType.FirstOrDefault(u => u.Id == obj.SizeTypeId);
            //};
        ...
        public IActionResult Upsert(int? id)
        {
            ...
            ProductVM productVM = new ProductVM()
            {
                ...
                SizeTypeSelectList = _prodRepo.GetAllDropdownList(WC.SizeTypeName)
            };
        ...
        public IActionResult Upsert(ProductVM productVM)
        {
            ...
            productVM.SizeTypeSelectList = _prodRepo.GetAllDropdownList(WC.SizeTypeName);
            return View(productVM);
        }
        ...
        public IActionResult Delete(int? id)
        {
            ...
            Product product = _prodRepo.FirstOrDefault(u=>u.Id==id,includeProperties:"Category,ApplicationType,SizeType");

...
namespace Relikt_2.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public async Task <IActionResult> SummaryPost(ProductUserVM ProductUserVM)
        {
            ...
            {
                productListSB.Append($" - Название: {prod.Name} <span style='font-size:14px;'> Тип Товара: {prod.ApplicationType.Name} <span style='font-size:14px;'> Цвет: {prod.Category.Name} <span style='font-size:14px;'> Размер: {prod.SizeType.Name} (Номер Заказа: {prod.Id})</span><br />");
            }
